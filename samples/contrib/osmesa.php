<?
/* $Id: osmesa.php,v 1.1 2001/10/12 12:16:38 drbrain Exp $ */
...
{
	$light_ambient = array( 0.0, 0.0, 0.0, 1.0 );
	$light_diffuse = array( 1.0, 1.0, 1.0, 1.0 );
	$light_specular = array( 1.0, 1.0, 1.0, 1.0 );
	$light_position = array( 1.0, 1.0, 1.0, 0.0 );
	$red_mat   = array( 1.0, 0.2, 0.2, 1.0 );
	$green_mat = array( 0.2, 1.0, 0.2, 1.0 );
	$blue_mat  = array( 0.2, 0.2, 1.0, 1.0 );
...
write_targa($filename, $buffer, $width, $height)
{
	...
	/*
	fwrite($fp,
		pack('C*',0,0,2,0,0,0,0,0,0,0,0,0) .
		pack('vvCC', $width, $height, 0x18, 0x20)
		);
	$tmp = '';
